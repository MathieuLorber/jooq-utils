        ...
        Configuration()
            ...
            .withGenerator(Generator()
                ...
                .withDatabase(Database()
                    .withName(
                        when (conf.driver) {
                            DatabaseConfiguration.Driver.psql -> PostgresDatabase::class.java.name
                            DatabaseConfiguration.Driver.mysql -> MySQLDatabase::class.java.name
                        }
                    )
                    .withIncludes(".*")
                    ...
                    .apply {
                        ...
                        val forcedTypes = when (conf.driver) {
